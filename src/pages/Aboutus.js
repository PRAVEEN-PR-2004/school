          ...
          <Row>
            <Col md={6}>
              ...
              >
                ...
                equipped with strong ethical values and the knowledge to thrive
                in a rapidly changing world. Our mission is to foster a
                supportive community that encourages academic excellence,
                self-discipline, and a lifelong love for learning.
              </p>
            </Col>
            <Col md={6}>
              <h3 style={{ fontFamily: "Playfair Display, serif" }}>
              ...
              >
                ...
                integrity, preparing students to contribute positively to
                society.
              </p>
            </Col>
          </Row>
          ...
          <Row className="mt-5 mb-5">
            ...
            >
              <div>
                ...
                >
                  “At St. Antony's, we believe in empowering our students with
                  the knowledge, skills, and values needed to face the
                  challenges of tomorrow. Our dedicated team strives to provide
                  a safe, nurturing, and stimulating environment where each
                  student can flourish and achieve their aspirations.”
                </p>
              </div>
            </Col>
          </Row>
